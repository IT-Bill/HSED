...
double getULP(double x, double origin) {
	mpfr_t mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8;
	mpfr_inits2(128, mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, (mpfr_ptr) 0);
	mpfr_set_d(mp1, 1, MPFR_RNDN);
	mpfr_set_d(mp2, x, MPFR_RNDN);
	mpfr_sub(mp3, mp1, mp2, MPFR_RNDN);
	mpfr_set_d(mp4, 1, MPFR_RNDN);
	mpfr_set_d(mp5, x, MPFR_RNDN);
	mpfr_add(mp6, mp4, mp5, MPFR_RNDN);
	mpfr_div(mp7, mp3, mp6, MPFR_RNDN);
	mpfr_log(mp8, mp7, MPFR_RNDN);

	mpfr_set(mpfr_oracle, mp8, MPFR_RNDN);
	mpfr_set_d(mpfr_origin, origin, MPFR_RNDN);
	double ulp = computeULPDiff(mpfr_origin, mpfr_oracle);
	mpfr_clears(mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, (mpfr_ptr) 0);
	mpfr_free_cache();
	return ulp;
}
double getRelativeError(double x, double origin) {
	mpfr_t mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8;
	mpfr_inits2(128, mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, (mpfr_ptr) 0);
	mpfr_set_d(mp1, 1, MPFR_RNDN);
	mpfr_set_d(mp2, x, MPFR_RNDN);
	mpfr_sub(mp3, mp1, mp2, MPFR_RNDN);
	mpfr_set_d(mp4, 1, MPFR_RNDN);
	...
	mpfr_clears(mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, (mpfr_ptr) 0);
	mpfr_free_cache();
	return relative;
}
