...
public:
    ...
    static void processPositiveRangeLayer23(double input_x, double ULP, double start, double end);
    static std::pair<double, double> processNegativeRangeLayer1(const double &start, const double &end);
    static void processNegativeRangeLayer23(double input_x, double ULP, double start, double end);
    static std::pair<double, double> processCrossZeroLayer1(const double &start, const double &end);
    static void processCrossZeroLayer23(double input_x, double ULP, double start, double end);
